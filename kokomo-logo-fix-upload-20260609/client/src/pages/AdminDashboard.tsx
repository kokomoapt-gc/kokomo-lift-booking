    ...
    return (
      <div className="min-h-screen bg-[var(--kokomo-black)] flex flex-col">
        <header className="px-8 py-6">
          <img src="/kokomo-logo.png" alt="KOKOMO Gold Coast" className="h-7 object-contain brightness-0 invert" />
        </header>
      ...
      <header className="bg-[var(--kokomo-black)] text-white sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <img src="/kokomo-logo.png" alt="KOKOMO Gold Coast" className="h-6 object-contain brightness-0 invert" />
